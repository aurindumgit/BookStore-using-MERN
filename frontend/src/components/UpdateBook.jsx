...
const UpdateBook = () => {
  ...
  return (
    <div className="update-book-container">
      <h1 style={{display:'flex',flexDirection: 'column',alignItems: 'center',justifyContent: 'center'}}>Update Book</h1>
      <h4 style={{display:'flex',flexDirection: 'column',alignItems: 'center',justifyContent: 'center'}}>Select a book to update:</h4>
